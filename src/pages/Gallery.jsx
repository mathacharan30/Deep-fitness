...
import imgGallery4 from '../assets/gallery/IMG20260408194051.jpg';
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="columns-1 md:columns-2 lg:columns-3 gap-6 space-y-6">
            <div className="break-inside-avoid animate-fade-up delay-100">
              <img className="w-full rounded shadow-xl transition-all duration-700" src={imgGallery1} />
            </div>
            ...
            <div className="break-inside-avoid animate-fade-up delay-300">
              <img className="w-full rounded shadow-xl transition-all duration-700" src={imgGallery3} />
            </div>
            <div className="break-inside-avoid animate-fade-up delay-100">
              <img className="w-full rounded shadow-xl" src={imgGallery4} />
            </div>
            <div className="break-inside-avoid animate-fade-up delay-200">
              <img className="w-full rounded shadow-xl transition-all duration-700" src={imgGallery5} />
            </div>
            <div className="break-inside-avoid animate-fade-up delay-300">
